"""7 个快捷演示案例（依据 docs/安心童伴AI-初赛Demo拆解.md 第三节）
...
DEMO_CASES: list[dict] = [
    ...
    },
    {
        ...
        "emoji": "🧠",
        "name": "案例6：学习引导",
        "preset_input": "帮我做这道数学题，我不会做",
        "expected_risk_level": 0,
        "expected_topic": "safe",
        "goal": "苏格拉底式提问 → 引导思考 → 不代写",
        "safety_closure": {
            "trigger": "孩子请求帮忙做作业/数学题",
            "step3_action": "苏格拉底式学习引导策略：先反问引导，分步给提示，绝不直接给答案",
            "boundary": "不代写作业、不直接给答案、不替代老师角色",
            "handoff": "鼓励孩子自己思考、查书或问老师",
            "parent_alert": "无家长提醒",
        },
    },
    {
        ...
        "emoji": "🎤",
        "name": "案例7：百科问答",
        "preset_input": "天空为什么是蓝色的？",
        "expected_risk_level": 0,
        "expected_topic": "safe",
        "goal": "百科问答 → 年龄适配 → 引导式解释",
        "safety_closure": {
            "trigger": "孩子提问科学知识，无风险信号",
            "step3_action": "百科模式：用适合孩子年龄的方式解释，低龄档用比喻，高龄档可引入科学术语",
            "boundary": "引导思考而非直接给答案，鼓励进一步探索",
            "handoff": "无转人工需求；建议种下好奇星",
            "parent_alert": "无家长提醒",
        },
    },
]
